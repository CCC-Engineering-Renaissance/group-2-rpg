// This is the first puzzle of room 2. It uses blackjack values (king and queen: 10, ace: 1 or 11). The answer for this puzzle is 5.
void puzzle_2_1() {
cout << center << "You see a lovely portrait of a king, queen, and their two sons. One son is just a baby, but the other one looks much older.\n"; 
cout << center << "Underneath the portrait, it says that both sons are named Ace.";
  }
...
void door_2(){
int passcode_2;
cout << center << "Hopefully you already caught on, but there were multiple puzzles in this room. Each puzzle’s answer needs to be reduced down to a single digit number.\n"; 
cout << center << "When entering these digits in the passcode, you will need to enter them based on the location of the puzzle in the room. The leftmost puzzle will have\n";
cout << center << "their number entered first. The second leftmost puzzle will have their number entered next, and so on and so forth. Now before you ask about that one\n";
cout << center << "puzzle in that one odd location, that one can be entered last.\n";
